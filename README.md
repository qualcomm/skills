...
A compatible coding agent (e.g., Claude Code). No additional build dependencies are required to use these skills — they are plain markdown/JSON files consumed directly by the agent.
